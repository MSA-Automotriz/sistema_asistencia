    ...
    async runDueSchedules(now = new Date()) {
        ...
        try {
            ...
            for (const setting of settings) {
                ...
                if (schedule.hour !== companyTime.hour || schedule.minute !== companyTime.minute)
                    continue;
                ...
                if (this.executedSlots.has(slot))
                    continue;
